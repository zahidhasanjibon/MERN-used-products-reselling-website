  ...
  return (
    ...
    alignItems: "center"}}>
            <div className=" flex-col gap-4 md:flex-row  items-center">
              <div className="w-1/2 absolute top-1/2 transform  translate-y-12 md:-translate-y-1/2 left-4 md:left-44">
                <h1 className="text-lg md:text-3xl text-red-500">
                  New Arrival
                </h1>
                <h5 className="py-4 text-xl md:text-5xl">
                  FAll -  Winter <br></br> 2022
                </h5>
    ...
    alignItems: "center"}}>
            <div className=" flex-col gap-4 md:flex-row   items-center">
              <div className="w-1/2 absolute top-1/2 transform  translate-y-12 md:-translate-y-1/2 left:-4 md:left-44">
                ...
                <h5 className="py-4 text-lg md:text-5xl">
                  FAll -  Winter <br></br> 2022
                </h5>
                <button className="btn btn-sm md:btn-lg btn-secondary btn-outline">
                  See Products{" "}
